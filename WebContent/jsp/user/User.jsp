...
<script>
	...
	$(document).ready(function() {
		$("#addDiv").load("./AddUser.jsp");
		$("#queryDiv").load("./QueryUser.jsp");
		$("#viewDiv").load("./ViewUser.jsp");
		$("#updateDiv").load("./UpdateUser.jsp");
		$("#deleteDiv").load("./DeleteUser.jsp");
...
<body>
	...
	<button id="add" name="add" class="ui-button ui-corner-all ui-widget">新增用戶</button>
